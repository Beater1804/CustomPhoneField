...
class _CountryPickerDialogState extends State<CountryPickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final defaultVerticalPadding = MediaQuery.of(context).size.height * 0.1;
    return Dialog(
              ...
              child: TextField(
                ...
                onChanged: (value) {
                  _filteredCountries = isNumeric(value)
                      ? widget.countryList
                      .where((country) => country.countryCode.contains(value))
                      .toList()
                      : widget.countryList
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (ctx, index) => Column(
                  children:[
                    ListTile(
                      leading: Text(_filteredCountries[index].flag, style: const TextStyle(fontSize: 32),),
                      ...
                      trailing: Text(
                        '+${_filteredCountries[index].countryCode}',
